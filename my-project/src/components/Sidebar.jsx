...
function Sidebar() {
  return (
    <div className='flex flex-col p-4 space-y-2 mt-8 md:block hidden'>
     <h1 className='text-2xl'>Filter</h1>
     <div className='flex flex-row space-x-4 items-center mt-2'>
     <div className='px-6 py-2 w-[129px] space-x-4 border border-black flex flex-row items-center'>
    ...
    <p>All</p>
     ...
     <div className='flex flex-col'>
      ...
      <div className='bg-white border border-black h-[294px] w-[275px] flex flex-col space-y-4 py-2'>
